...
public class RegisterTest extends BaseTest {
    ...
    public void userShouldRegisterAccountSuccessfully(){
        ...
        driver.findElement(By.id("email_address")).sendKeys("casinoroyaljamesbond8@gmail.com");
        driver.findElement(By.id("password")).sendKeys("Bond008%");
        driver.findElement(By.id("password-confirmation")).sendKeys("Bond008%");
